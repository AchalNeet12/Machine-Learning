...
# limporting the dataset 
dataset=pd.read_csv(r"E:\3.spyder\clustering\Mall_Customers.csv")
X = dataset.iloc[:,[3,4]].values

# Using the elow method to find the optimal number of clustor
from sklearn.cluster import KMeans
# to findout the optimal
wcss=[]
...
#we choose 1-11 becuase the 11 bound is excluded & we want 10 
# wcss however the first bound is included so hear i = 1,2,3 to 10
